...
my [Ship React Native boilerplate](/mobile-apps) and every client build use Expo managed workflow with EAS. The boilerplate ships with EAS Build, EAS Update, and EAS Submit configured. I've shipped 20+ apps on this stack.
