...
export default function MoonLatteTermsOfService() {
  return (
        ...
        >
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
              <span className="gradient-text">MoonLatte</span> Terms of Service
            </h1>
            <p className="text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed">
              Simple terms for a simple caffeine tracker with no tracking.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <Section title="1. Acceptance of Terms" icon={FileText} iconColor="blue">
              <p className="text-zinc-300">
                By downloading or using MoonLatte, you agree to these Terms of Service. If you do not agree, please do not use the app.
              </p>
            </Section>

            <Section title="2. Intended Use" icon={Heart} iconColor="emerald">
              <p className="text-zinc-300">
                MoonLatte is intended for personal caffeine tracking only. It is not a medical device and does not provide medical advice.
              </p>
            </Section>

            <Section title="3. Privacy and Data" icon={Shield} iconColor="purple">
              <p className="text-zinc-300">
                MoonLatte does not collect personal data or track users. All entries and settings remain on your device. See the Privacy Policy for details.
              </p>
            </Section>
