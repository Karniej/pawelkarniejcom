              ...
              <Card className="bg-card/50 backdrop-blur-sm border border-white/10">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <a
                      href="/privacy-policy/yapperx"
                      className="block p-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-amber-500/30 transition-all duration-300 cursor-pointer group hover:scale-105 no-underline"
                    >
                      <h3 className="font-semibold text-amber-400 mb-2 group-hover:text-amber-300 transition-colors">
                        YapperX
                      </h3>
                      <p className="text-sm text-zinc-400 mb-3">
                        Simple privacy overview for the lightweight companion
                        app
                      </p>
                    ...
                    <a
                      href="/privacy-policy/beatai"
                      className="block p-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-sky-500/30 transition-all duration-300 cursor-pointer group hover:scale-105 no-underline"
                    >
                      <h3 className="font-semibold text-sky-400 mb-2 group-hover:text-sky-300 transition-colors">
                        BeatAI
                      </h3>
                      <p className="text-sm text-zinc-400 mb-3">
                        Audio analysis and practice data privacy details
                      </p>
                    ...
                    <a
                      href="/privacy-policy/vidnotes"
                      className="block p-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-pink-500/30 transition-all duration-300 cursor-pointer group hover:scale-105 no-underline"
                    >
