...
export default function VidNotesPrivacyPolicy() {
  return (
        ...
        >
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
              <span className="gradient-text">VidNotes</span> Privacy Policy
            </h1>
            <p className="text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed">
              A private-first video notes companion with no tracking and no remote storage.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <Section title="1. What We Collect" icon={Database} iconColor="emerald">
              <p className="text-zinc-300">
                VidNotes does not collect, track, or transmit any personal data.
            ...
            <Section title="2. Where Your Data Lives" icon={Lock} iconColor="purple">
              <div className="space-y-4">
                <p className="text-zinc-300">
                  Any notes, recordings, or preferences you create are stored locally on your device.
                ...
                <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 text-green-100 text-sm">
                  <strong>Local-only:</strong> We do not operate servers for VidNotes and we do not process your data remotely.
                </div>
              </div>
            </Section>
            ...
            <Section title="3. Third-Party Services" icon={FileText} iconColor="blue">
              <p className="text-zinc-300">
                VidNotes does not use third-party analytics, advertising, or tracking services.
                If the app uses platform features (e.g., iCloud device backups), those are governed by your platform provider&apos;s policies.
              </p>
            </Section>
            ...
            <Section title="5. Changes to This Policy" icon={FileText} iconColor="purple">
              <p className="text-zinc-300">
                If we ever change how VidNotes handles data, we will update this page. As of December 2024, VidNotes collects no data.
              </p>
            </Section>
